! function (e, t) {
	...
	w.fn = w.prototype = {
		...
		for ("boolean" == typeof r && (u = r, r = arguments[a] || {}, a++), "object" == typeof r || m(r) || (r = {}), a === l && (r = this, a--); a < l; a++)
			if (null != (e = arguments[a]))
				for (t in e) i = e[t], "__proto__" !== t && r !== i && (u && i && (w.isPlainObject(i) || (o = Array.isArray(i))) ? (n = r[t], s = o && !Array.isArray(n) ? [] : o || w.isPlainObject(n) ? n : {}, o = !1, r[t] = w.extend(u, s, i)) : void 0 !== i && (r[t] = i));
		return r
	}, w.extend({
	...
	var k = function (e) {
		var t, n, i, o, s, r, a, l, u, c, d, f, h, p, m, g, v, y, b, x = "sizzle" + 1 * new Date,
			w = e.document,
			C = 0,
			T = 0,
			k = le(),
		...
		function ae(e, t, i, o) {
			var s, a, u, c, d, p, v, y = t && t.ownerDocument,
				C = t ? t.nodeType : 9;
			...
			if (!o && ((t ? t.ownerDocument || t : w) !== h && f(t), t = t || h, m)) {
				if (11 !== C && (d = Z.exec(e)))
					if (s = d[1]) {
						...
						if ((s = d[3]) && n.getElementsByClassName && t.getElementsByClassName) return I.apply(i, t.getElementsByClassName(s)), i
					}
		...
		for (t in n = ae.support = {}, s = ae.isXML = function (e) {
				...
				var o = i.attrHandle[t.toLowerCase()],
					s = o && L.call(i.attrHandle, t.toLowerCase()) ? o(e, t, !m) : void 0;
					...
					for (; t = t[i];)
						if (1 === t.nodeType || r)
							if (c = (d = t[x] || (t[x] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t;
								...
								if ((u = c[s]) && u[0] === C && u[1] === a) return f[2] = u[2];
								if ((c[s] = f)[2] = e(t, n, l)) return !0
							} return !1
			}
		}
		...
		function Te(e, t, n, i, o, s) {
			return i && !i[x] && (i = Te(i)), o && !o[x] && (o = Te(o, s)), ue(function (s, r, a, l) {
				var u, c, d, f = [],
					h = [],
					p = r.length,
					m = s || function (e, t, n) {
				...
				if (s) {
					if (o || e) {
						...
						for (c = v.length; c--;)(d = v[c]) && -1 < (u = o ? N(s, d) : f[c]) && (s[u] = !(r[u] = d))
					}
				} else v = Ce(v === r ? v.splice(p, v.length) : v), o ? o(null, r, v, l) : I.apply(r, v)
			})
		}

		function ke(e) {
			for (var t, n, o, s = e.length, r = i.relative[e[0].type], a = r || i.relative[" "], l = r ? 1 : 0, c = xe(function (e) {
					return e === t
				}, a, !0), d = xe(function (e) {
					return -1 < N(t, e)
				...
				if (n = i.relative[e[l].type]) f = [xe(we(f), n)];
					...
					if ((n = i.filter[e[l].type].apply(null, e[l].matches))[x]) {
						...
						return Te(1 < l && we(f), 1 < l && be(e.slice(0, l - 1).concat({
							value: " " === e[l - 2].type ? "*" : ""
						})).replace(R, "$1"), n, l < o && ke(e.slice(l, o)), o < s && ke(e = e.slice(o)), o < s && be(e))
					}
					f.push(n)
				}
			return we(f)
		...
		return ye.prototype = i.filters = i.pseudos, i.setFilters = new ye, r = ae.tokenize = function (e, t) {
			var n, o, s, r, a, l, u, c = S[e + " "];
			if (c) return t ? 0 : c.slice(0);
			for (a = e, l = [], u = i.preFilter; a;) {
				for (r in n && !(o = B.exec(a)) || (o && (a = a.slice(o[0].length) || a), l.push(s = [])), n = !1, (o = F.exec(a)) && (n = o.shift(), s.push({
						value: n,
						type: o[0].replace(R, " ")
					}), a = a.slice(n.length)), i.filter) !(o = G[r].exec(a)) || u[r] && !(o = u[r](o)) || (n = o.shift(), s.push({
					value: n,
					type: r,
					matches: o
				}), a = a.slice(n.length));
			...
			if (!g) {
				...
				(g = E(e, (o = p, a = 0 < (s = d).length, l = 0 < o.length, c = function (e, t, n, r, c) {
					var d, p, g, v = 0,
						y = "0",
						b = e && [],
						x = [],
					...
					if (v += y, a && y !== v) {
						...
						I.apply(r, x), c && !e && 0 < x.length && 1 < v + s.length && ae.uniqueSort(r)
					}
					return c && (C = k, u = w), b
				}, a ? ue(c) : c))).selector = e
			}
			...
			var s, l, u, c, d, f = "function" == typeof e && e,
			...
			if (n = n || [], 1 === h.length) {
				...
				for (s = G.needsContext.test(e) ? 0 : l.length; s-- && (u = l[s], !i.relative[c = u.type]);)
					if ((d = i.find[c]) && (o = d(u.matches[0].replace(te, ne), ee.test(l[0].type) && ve(t.parentNode) || t))) {
						if (l.splice(s, 1), !(e = o.length && be(l))) return I.apply(n, o), n;
						break
					}
			}
	...
	(w.fn.init = function (e, t, n) {
		...
		if (n = n || D, "string" == typeof e) {
			...
			if (o[1]) {
				if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), L.test(o[1]) && w.isPlainObject(t))
	...
	w.Callbacks = function (e) {
		...
		var i, o, s, r, a = [],
			...
			u = -1,
			c = function () {
				for (r = r || e.once, s = i = !0; l.length; u = -1)
			...
			d = {
				...
				fireWith: function (e, t) {
					return r || (t = [e, (t = t || []).slice ? t.slice() : t], l.push(t), i || c()), this
				},
				fire: function () {
				...
				o = {
					...
					then: function (t, i, o) {
								...
								var a = this,
									...
									u = function () {
										...
										if (!(t < s)) {
											...
											u = e && ("object" == typeof e || "function" == typeof e) && e.then, m(u) ? o ? u.call(e, r(s, n, P, o), r(s, n, M, o)) : (s++, u.call(e, r(s, n, P, o), r(s, n, M, o), r(s, n, P, n.notifyWith))) : (i !== P && (a = void 0, l = [e]), (o || n.resolveWith)(a, l))
										}
									},
									c = o ? u : function () {
										try {
											...
											w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace), s <= t + 1 && (i !== M && (a = void 0, l = [e]), n.rejectWith(a, l))
										}
									};
						...
						return w.Deferred(function (e) {
							n[0][3].add(r(0, e, m(o) ? o : P, e.notifyWith)), n[1][3].add(r(0, e, m(t) ? t : P)), n[2][3].add(r(0, e, m(i) ? i : M))
						}).promise()
					},
					promise: function (e) {
		...
		when: function (e) {
			...
			if (t <= 1 && (q(e, r.done(a(n)).resolve, r.reject, !t), "pending" === r.state() || m(o[n] && o[n].then))) return r.then();
	...
	var B = function (e, t, n, i, o, s, r) {
			...
			else if (void 0 !== i && (o = !0, m(i) || (r = !0), u && (r ? (t.call(e, i), t = null) : (u = t, t = function (e, t, n) {
					return u.call(w(e), n)
				})), t))
		...
		data: function (e, t) {
			...
			if (void 0 === e) {
				if (this.length && (o = K.get(s), 1 === s.nodeType && !V.get(s, "hasDataAttrs"))) {
					for (n = r.length; n--;) r[n] && 0 === (i = r[n].name).indexOf("data-") && (i = X(i.slice(5)), ee(s, i, o[i]));
	...
	function we(e, t, n, i, o) {
		for (var s, r, a, l, u, c, d = t.createDocumentFragment(), f = [], h = 0, p = e.length; h < p; h++)
			...
			for (r = r || d.appendChild(t.createElement("div")), a = (he.exec(s) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, r.innerHTML = l[1] + w.htmlPrefilter(s) + l[2], c = l[0]; c--;) r = r.lastChild;
			w.merge(f, r.childNodes), (r = d.firstChild).textContent = ""
		} else f.push(t.createTextNode(s));
		for (d.textContent = "", h = 0; s = f[h++];)
			if (i && -1 < w.inArray(s, i)) o && o.push(s);
			else if (u = se(s), r = ge(d.appendChild(s), "script"), u && ve(r), n)
			for (c = 0; s = r[c++];) pe.test(s.type || "") && n.push(s);
		return d
	}
	...
	function Le(e, t, n) {
		n ? (V.set(e, t, !1), w.event.add(e, t, {
			namespace: !1,
			handler: function (e) {
				var i, o, r = V.get(this, t);
				if (1 & e.isTrigger && this[t]) {
					if (r.length)(w.event.special[t] || {}).delegateType && e.stopPropagation();
					else if (r = s.call(arguments), V.set(this, t, r), i = n(this, t), this[t](), r !== (o = V.get(this, t)) || i ? V.set(this, t, !1) : o = {}, r !== o) return e.stopImmediatePropagation(), e.preventDefault(), o.value
	...
	w.event = {
		...
		add: function (e, t, n, i, o) {
			var s, r, a, l, u, c, d, f, h, p, m, g = V.get(e);
			if (g)
				for (n.handler && (n = (s = n).handler, o = s.selector), o && w.find.matchesSelector(oe, o), n.guid || (n.guid = w.guid++), (l = g.events) || (l = g.events = {}), (r = g.handle) || (r = g.handle = function (t) {
					...
					namespace: p.join(".")
				}, s), (f = l[h]) || ((f = l[h] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, p, r) || e.addEventListener && e.addEventListener(h, r)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, c) : f.push(c), w.event.global[h] = !0)
		},
		remove: function (e, t, n, i, o) {
			var s, r, a, l, u, c, d, f, h, p, m, g = V.hasData(e) && V.get(e);
			if (g && (l = g.events)) {
				for (u = (t = (t || "").match(z) || [""]).length; u--;)
					if (h = m = (a = ke.exec(t[u]) || [])[1], p = (a[2] || "").split(".").sort(), h) {
						for (d = w.event.special[h] || {}, f = l[h = (i ? d.delegateType : d.bindType) || h] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = f.length; s--;) c = f[s], !o && m !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (f.splice(s, 1), c.selector && f.delegateCount--, d.remove && d.remove.call(e, c));
						r && !f.length && (d.teardown && !1 !== d.teardown.call(e, p, g.handle) || w.removeEvent(e, h, g.handle), delete l[h])
					} else
			...
			if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
				for (r = w.event.handlers.call(this, a, u), t = 0;
					...
					for (a.currentTarget = o.elem, n = 0;
						(s = o.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !1 !== s.namespace && !a.rnamespace.test(s.namespace) || (a.handleObj = s, a.data = s.data, void 0 !== (i = ((w.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
			...
			if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
				for (; u !== this; u = u.parentNode || this)
					if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
						for (s = [], r = {}, n = 0; n < l; n++) void 0 === r[o = (i = t[n]).selector + " "] && (r[o] = i.needsContext ? -1 < w(o, this).index(u) : w.find(o, this, null, [u]).length), r[o] && s.push(i);
						s.length && a.push({
							elem: u,
							handlers: s
						})
		...
		special: {
			...
			click: {
				setup: function (e) {
					var t = this || e;
					return fe.test(t.type) && t.click && _(t, "input") && Le(t, "click", Se), !1
				},
				trigger: function (e) {
					var t = this || e;
					return fe.test(t.type) && t.click && _(t, "input") && Le(t, "click"), !0
				},
				_default: function (e) {
					var t = e.target;
	...
	function Pe(e, t) {
		var n, i, o, s, r, a, l, u;
		if (1 === t.nodeType) {
			if (V.hasData(e) && (s = V.access(e), r = V.set(t, s), u = s.events))
	...
	function Me(e, t, n, i) {
		...
		var o, s, a, l, u, c, d = 0,
			...
			g = t[0],
			v = m(g);
		if (v || 1 < f && "string" == typeof g && !p.checkClone && je.test(g)) return e.each(function (o) {
			var s = e.eq(o);
			v && (t[0] = g.call(this, o, s.html())), Me(s, t, n, i)
		});
		if (f && (s = (o = we(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
	...
	function qe(e, t, n) {
		for (var i, o = t ? w.filter(t, e) : e, s = 0; null != (i = o[s]); s++) n || 1 !== i.nodeType || w.cleanData(ge(i)), i.parentNode && (n && se(i) && ve(ge(i, "script")), i.parentNode.removeChild(i));
		return e
	}
	w.extend({
		...
		clone: function (e, t, n) {
			...
			if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
				for (r = ge(c), i = 0, o = (s = ge(e)).length; i < o; i++) a = s[i], "input" === (u = (l = r[i]).nodeName.toLowerCase()) && fe.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
			if (t)
				if (n)
					for (s = s || ge(e), r = r || ge(c), i = 0, o = s.length; i < o; i++) Pe(s[i], r[i]);
				else Pe(e, c);
	...
	function Fe(e, t) {
		...
		function t() {
			if (c) {
				...
				o = "1%" !== t.top, l = 12 === n(t.marginLeft), c.style.right = "60%", a = 36 === n(t.right), s = 36 === n(t.width), c.style.position = "absolute", r = 12 === n(c.offsetWidth / 3), oe.removeChild(u), c = null
			}
		}
		...
		var o, s, r, a, l, u = i.createElement("div"),
	...
	function et(e, t, n, i, o, s) {
		...
		for (; r < 4; r += 2) "margin" === n && (l += w.css(e, n + ie[r], !0, o)), i ? ("content" === n && (l -= w.css(e, "padding" + ie[r], !0, o)), "margin" !== n && (l -= w.css(e, "border" + ie[r] + "Width", !0, o))) : (l += w.css(e, "padding" + ie[r], !0, o), "padding" !== n ? l += w.css(e, "border" + ie[r] + "Width", !0, o) : a += w.css(e, "border" + ie[r] + "Width", !0, o));
		...
		style: function (e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var o, s, r, a = X(t),
					l = Ve.test(t),
					u = e.style;
				if (l || (t = Ge(a)), r = w.cssHooks[t] || w.cssHooks[a], void 0 === n) return r && "get" in r && void 0 !== (o = r.get(e, !1, i)) ? o : u[t];
				"string" == (s = typeof n) && (o = ne.exec(n)) && o[1] && (n = ue(e, t, o), s = "number"), null != n && n == n && ("number" !== s || l || (n += o && o[3] || (w.cssNumber[a] ? "" : "px")), p.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), r && "set" in r && void 0 === (n = r.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
			}
		},
		...
		w.cssHooks[t] = {
			...
			set: function (e, n, i) {
				var o, s = We(e),
					...
					l = i ? et(e, t, i, a, s) : 0;
				return a && r && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(s[t]) - et(e, t, "border", !1, s) - .5)), l && (o = ne.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = w.css(e, t)), Ze(0, n, l)
			}
		}
		...
		css: function (e, t) {
			return B(this, function (e, t, n) {
				var i, o, s = {},
					r = 0;
				if (Array.isArray(t)) {
					for (i = We(e), o = t.length; r < o; r++) s[t[r]] = w.css(e, t[r], !1, i);
					return s
				}
	...
	function ht(e, t, n) {
		var i, o, s = 0,
			...
			l = function () {
				if (o) return !1;
				for (var t = it || ct(), n = Math.max(0, u.startTime + u.duration - t), i = 1 - (n / u.duration || 0), s = 0, r = u.tweens.length; s < r; s++) u.tweens[s].run(i);
		...
		for (function (e, t) {
			...
			if (i = ht.prefilters[s].call(u, e, c, u.opts)) return m(i.stop) && (w._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
	...
	w.extend(w.event, {
		trigger: function (t, n, o, s) {
			...
			if (a = p = l = o = o || i, 3 !== o.nodeType && 8 !== o.nodeType && !Ct.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), c = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = s ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : w.makeArray(n, [t]), h = w.event.special[y] || {}, s || !h.trigger || !1 !== h.trigger.apply(o, n))) {
				...
				for (r = 0;
					(a = v[r++]) && !t.isPropagationStopped();) p = a, t.type = 1 < r ? u : h.bindType || y, (f = (V.get(a, "events") || {})[t.type] && V.get(a, "handle")) && f.apply(a, n), (f = c && a[c]) && f.apply && G(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
				return t.type = y, s || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(v.pop(), n) || !G(o) || c && m(o[y]) && !g(o) && ((l = o[c]) && (o[c] = null), w.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, Tt), o[y](), t.isPropagationStopped() && p.removeEventListener(y, Tt), w.event.triggered = void 0, l && (o[c] = l)), t.result
			}
		},
	...
	w.param = function (e, t) {
		...
		serializeArray: function () {
			return this.map(function () {
				...
				var e = this.type;
				return this.name && !w(this).is(":disabled") && At.test(this.nodeName) && !Lt.test(e) && (this.checked || !fe.test(e))
			}).map(function (e, t) {
				var n = w(this).val();
	...
	Wt.href = kt.href, w.extend({
		...
		ajax: function (t, n) {
			...
			var o, s, r, a, l, u, c, d, f, h, p = w.ajaxSetup({}, n),
				m = p.context || p,
			...
			function S(t, n, i, a) {
				var u, f, h, x, C, T = n;
				c || (c = !0, l && e.clearTimeout(l), o = void 0, r = a || "", k.readyState = 0 < t ? 4 : 0, u = 200 <= t && t < 300 || 304 === t, i && (x = function (e, t, n) {
	...
	w.ajaxSetup({
		...
		return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (p.createHTMLDocument ? ((o = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, t.head.appendChild(o)) : t = i), r = !n && [], (s = L.exec(e)) ? [t.createElement(s[1])] : (s = we([e], t, r), r && r.length && w(r).remove(), w.merge([], s.childNodes)));
		var o, s, r
		...
		setOffset: function (e, t, n) {
			var i, o, s, r, a, l, u = w.css(e, "position"),
				c = w(e),
				d = {};
			"static" === u && (e.style.position = "relative"), a = c.offset(), s = w.css(e, "top"), l = w.css(e, "left"), ("absolute" === u || "fixed" === u) && -1 < (s + l).indexOf("auto") ? (r = (i = c.position()).top, o = i.left) : (r = parseFloat(s) || 0, o = parseFloat(l) || 0), m(t) && (t = t.call(e, n, w.extend({}, a))), null != t.top && (d.top = t.top - a.top + r), null != t.left && (d.left = t.left - a.left + o), "using" in t ? t.using.call(e, d) : c.css(d)
		}
	}, w.fn.extend({
		offset: function (e) {
	...
	var t = {
		init: function (t) {
			return this.each(function () {
				...
				! function (t) {
					if (n.hasClass("clb-slider")) var o = n.find("> .clb-slider-outer-stage > .clb-slider-stage > .clb-slider-item");
						...
						if (t.dots) {
							...
							c.find(".clb-slider-dot:first-child").addClass("active"), n.append(c), s = n.find("> .clb-slider-nav-dots > .clb-slider-dot")
						}
						if (t.pagination) {
							...
							p.find(".clb-slider-page:first-child").addClass("active"), n.append(p), r = n.find("> .clb-slider-pagination > .clb-slider-page")
						}
						if (t.slidesCount) {
				...
				function b(t, n, s, r, l, c) {
					t.trigger("clb-slider.change").trigger("clb-slider.next-change"), (n.loop && u != i - a || u < a) && (r.removeClass("active prev-slide next-slide"), s.css({
						transition: "1s"
					}), n.loop && ++u, n.loop ? (n.dots || n.pagination) && S(u - a) : (n.dots || n.pagination) && S(u), r.slice(u, u + n.items).addClass("active"), e(r[u - 1]).addClass("prev-slide"), e(r[u + n.items]).addClass("next-slide"), d = n.verticalScroll ? -t.height() / n.items * u - n.gap / n.items * u : -t.width() / n.items * u - n.gap / n.items * u, E(), n.loop || u++, n.loop && u - n.items, u == i - a && n.loop && (r.slice(a, a + n.items).addClass("active"), 1, setTimeout(function () {
						t.find("> .clb-slider-outer-stage > .clb-slider-stage > .cloned").removeClass("active"), e(r[u = a]).addClass("active"), d = n.verticalScroll ? -t.height() / n.items * u - n.gap / n.items * u : -t.width() / n.items * u - n.gap / n.items * u, E(), (n.dots || n.pagination) && S(u - a), s.css({
							transition: "none"
						}), o && k()
				...
				function x(t, n, s, r, l, c) {
					t.trigger("clb-slider.change").trigger("clb-slider.prev-change"), (n.loop && u != a - n.items || u > 1) && (s.css({
						transition: "1s"
					}), n.loop || --u - 1, d = n.verticalScroll ? -t.height() / n.items * (u - 1) - n.gap / n.items * u + +n.gap / n.items : -t.width() / n.items * (u - 1) - n.gap / n.items * u + +n.gap / n.items, E(), n.loop && --u - 1, n.loop ? ((n.dots || n.pagination) && S(u - a < 0 ? u : u - a), r.removeClass("active prev-slide next-slide"), r.slice(u, u + n.items).addClass("active"), e(r[u - 2]).addClass("prev-slide"), e(r[u + n.items]).addClass("next-slide")) : ((n.dots || n.pagination) && S(u - 1), r.removeClass("active prev-slide next-slide"), r.slice(u - 1, u + n.items - 1).addClass("active"), e(r[u - 2]).addClass("prev-slide"), e(r[u + n.items - 1]).addClass("next-slide")), u == a - n.items && n.loop && (r.slice(2 * a - n.items, 2 * a - n.items + n.items).addClass("active"), i - n.items - 1, setTimeout(function () {
						t.find("> .clb-slider-outer-stage > .clb-slider-stage > .cloned").removeClass("active"), u = 2 * a - n.items, e(r[u]).addClass("active"), d = n.verticalScroll ? -t.height() / n.items * u - n.gap / n.items * u : -t.width() / n.items * u - n.gap / n.items * u, s.css({
							transition: "none"
				...
				function S(t) {
					s && (s.removeClass("active"), e(s[t]).addClass("active")), r && (r.removeClass("active"), e(r[t]).addClass("active"))
				}
				...
				function $() {
					...
					if (d = t.verticalScroll ? -n.height() / t.items * u - t.gap / t.items * u : -n.width() / t.items * u - t.gap / t.items * u, E(), v.removeClass("active"), v.slice(u, u + t.items).addClass("active"), e(v[u - 1]).addClass("prev-slide"), e(v[u + t.items]).addClass("next-slide"), t.verticalScroll) {
						...
						var s = (a = n.height()) / t.items - t.gap + t.gap / t.items,
							r = a * i / t.items + t.gap / t.items * i;
						v.css("height", s + "px"), v.css("margin-right", t.gap + "px"), n.css("height", s);
						var a = v.height();
						n.find("> .clb-slider-stage").css({
							height: r + "px",
							width: "auto"
				...
				function _(t) {
					...
					!0 === p.mousewheel && function (t, n, o, a) {
						...
						t.on("wheel mousewheel", function (c) {
							...
							d > 0 && u < i ? (b(t, n, o, a, s, r), l = !1, c.preventDefault()) : d < 0 && u > 1 && (x(t, n, o, a, s, r), l = !1, c.preventDefault()), setTimeout(function () {
								l = !0
							}, f)
						})
					}(n, p, g, v);
					!0 === p.drag && function (t, n, i, o) {
						...
						e(i).on("mousedown touchstart", function (u) {
							...
							"touchstart" == u.type && (c = u.originalEvent.touches[0].pageX), e(i).on("mousemove touchmove", function (u) {
								if (1 == a) {
									var d = u.pageX;
									"touchmove" == u.type && (d = u.originalEvent.touches[0].pageX, l = 10), d + l < c ? (b(t, n, i, o, s, r), c = u.clientX, a = !1, e(i).find("a").on("click", function (e) {
										e.preventDefault()
									})) : d - l > c && (x(t, n, i, o, s, r), c = u.clientX, a = !1, e(i).find("a").on("click", function (e) {
										e.preventDefault()
									}))
								}
							}), setTimeout(function () {
					...
					!0 === p.autoplay && function (t, n, i, o) {
						var a = setInterval(function () {
							t.hasClass("stop-slide") || b(t, n, i, o, s, r)
						}, n.autoplayTimeout);
					...
					e(window).on("keydown", function (e) {
						...
						37 == t && x(n, p, g, v, s, r), 39 == t && b(n, p, g, v, s, r)
				...
				var L = !1,
					A = e(window).width();
				e(window).on("resize", function () {
					e(window).width() != A && (m = new Date, !1 === L && (L = !0, setTimeout(function () {
...
function (e, t) {
	...
	i.extend(f, t.prototype), f.option = function (e) {
		...
		var n = r(s);
		return n.defaults = i.extend({}, s.defaults), i.extend(n.defaults, t), n.compatOptions = i.extend({}, s.compatOptions), n.namespace = e, n.data = s.data, n.Item = r(o), i.htmlInit(n, e), l && l.bridget && l.bridget(e, n), n
	};
	var h = {
		ms: 1,
		s: 1e3
...
function (e, t) {
	...
	return i._resetLayout = function () {
		...
		for (var l = (this._getOption("originTop") ? i.top : i.bottom) + n.outerHeight, u = r; u <= a; u++) this.colYs[u] = Math.max(l, this.colYs[u])
					...
					value: function (e, t, n) {
						if (e.el = "string" == typeof n ? document.querySelector(n) : n, e.options = i({}, s.default, t), e.isInput = "input" === e.el.tagName.toLowerCase(), e.attr = e.options.attr, e.bindInputFocusEvents = e.options.bindInputFocusEvents, e.showCursor = !e.isInput && e.options.showCursor, e.cursorChar = e.options.cursorChar, e.cursorBlinking = !0, e.elContent = e.attr ? e.el.getAttribute(e.attr) : e.el.textContent, e.contentType = e.options.contentType, e.typeSpeed = e.options.typeSpeed, e.startDelay = e.options.startDelay, e.backSpeed = e.options.backSpeed, e.smartBackspace = e.options.smartBackspace, e.backDelay = e.options.backDelay, e.fadeOut = e.options.fadeOut, e.fadeOutClass = e.options.fadeOutClass, e.fadeOutDelay = e.options.fadeOutDelay, e.isPaused = !1, e.strings = e.options.strings.map(function (e) {
							...
							var o = Array.prototype.slice.apply(e.stringsElement.children),
								...
								l = void 0;
							try {
								for (var u, c = o[Symbol.iterator](); !(r = (u = c.next()).done); r = !0) {
									var d = u.value;
...
function (e, t, n) {
	"use strict";
	var i, o, s, r, a, l, u, c, d, f, h, p, m, g, v, y, b = "accessibleMegaMenu",
		x = {
	...
	C.prototype = (g = 0, v = "", y = "function" == typeof t.hasOwnProperty && !!t.hasOwnProperty("ontouchstart"), i = function (t) {
		...
		switch (f.is(".hover:tabbable") && e("html").off("keydown.accessible-megamenu"), k) {
			case w.ESCAPE:
				...
				break;
			case w.DOWN:
				n.preventDefault(), $ ? (s.call(h, n), S = 1 === y.find("." + p.panelClass + " :tabbable:first").focus().length) : S = 1 === b.filter(":gt(" + b.index(f) + "):first").focus().length, !S && t.opera && "[object Opera]" === opera.toString() && (n.ctrlKey || n.metaKey) && (l = (b = e(":tabbable")).index(f), S = 1 === e(":tabbable:gt(" + e(":tabbable").index(f) + "):first").focus().length);
				break;
			case w.UP:
	...
	function (e, t) {
		...
		return function (e) {
				...
				function c() {
					...
					if (d = arguments, f = this, g = e, n) {
						if (void 0 === m) return function (e) {
							return x = e, m = setTimeout(l, t), w ? s(e) : p
						}(g);
						if (C) return clearTimeout(m), m = setTimeout(l, t), s(g)
					}
			...
			function n() {
				for (var e, t, n = 0, o = s.length; o > n; n++) {
					e = s[n];
					for (var r, a = 0, l = (t = i.querySelectorAll(e.selector)).length; l > a; a++)(r = t[a]).ready || (r.ready = !0, e.fn.call(r, r))
				}
			}
			Object.defineProperty(t, "__esModule", {
				value: !0
		...
		s.find(".title").click(function (e) {
				s.toggleClass("active")
			}), $(document).click(function (e) {
				0 == $(e.target).closest(s).length && s.removeClass("active")
			}), setTimeout(function () {
				i()
			}, 2e3),
			function () {
				var e = 0;
				if (megaMenu = $("#masthead #mega-menu-wrap"), $(".clb-hamburger").on("click", function () {
						l(".main-nav .mbl-overlay")
					}), $('.clb-close, .mbl-overlay-bg, .mobile-header #site-navigation a[href^="#"]').on("click", function () {
						$("#mega-menu-sub-" + e).removeClass("active"), $("#mega-menu-sub-" + e).removeAttr("id"), e--, $("#site-navigation").removeClass("active"), $(".close-menu").css("right", "-100%"), $(".clb-hamburger").removeClass("hidden"), $("#masthead .search").removeClass("visible"), $(window).width() <= 768 && u($(".main-nav .mbl-overlay"))
					}), $(window).width() <= 768 && $(document).on("keydown", function (e) {
						27 == e.keyCode && u($(".main-nav .mbl-overlay"))
					}), $("a.menu-link").on("click", function () {
						"#" == $(this).attr("href")[0] && (e = 0, $('[id^="mega-menu-sub-"]').removeClass("active"), $('[id^="mega-menu-sub-"]').removeAttr("id"), $("#site-navigation").removeClass("active"), $(".close-menu").css("right", "-100%"), $(".clb-hamburger").removeClass("hidden"), $("#masthead .search").removeClass("visible"))
					}), $(".has-submenu > a").on("click touchend", function (t) {
						if ($(window).width() <= 768) {
							var n = $(this).parent(),
								a = n.find(".sub-nav > ul.sub-menu, > .sub-sub-nav > ul.sub-sub-menu, .submenu"),
								l = n.find(">.sub-nav >.sub-menu, >.sub-sub-nav >.sub-sub-menu");
							if (n.hasClass("menu-item-depth-0") && !n.hasClass("active-main-item")) $(".sub-nav >.sub-menu, .sub-sub-nav >.sub-sub-menu").removeAttr("style"), $(".active-main-item").find(".sub-menu.active, .sub-sub-menu.active").removeClass("active"), $(".active-main-item").removeClass("active-main-item active"), n.addClass("active-main-item");
							else if (n.hasClass("active-main-item")) return o(), !1;
							if (e > 0 && s(), $(this).hasClass("active") || n.hasClass("active")) return r(n), i(), n.hasClass("menu-item-depth-" + e) || e--, $(this).removeClass("active"), $(".sub-menu").removeAttr("style"), !1;
							n.hasClass("menu-item-depth-" + e) || e++, n.hasClass("sub-nav-item") && ($(".sub-nav >.sub-menu, .sub-sub-nav >.sub-sub-menu").removeAttr("style"), i());
							var u = l.find("> .mega-menu-item");
							return l.css("height", function (e) {
								var t = 0;
								return e.each(function () {
									var e = $(this).outerHeight();
									t += e
								}), t
							}(u) + "px"), n.addClass("active"), a.addClass("active"), $(".menu-link").removeClass("active"), $(this).addClass("active"), !1
						}
						if ($(window).width() <= 768) {
							var c = $(this);
							return $(".sub-sub-nav, .menu-link").removeClass("open active"), $(this).addClass("active"), $(this).siblings(".sub-sub-nav").addClass("open"), $(document).on("mouseup touchstart", function (e) {
								0 === c.has(e.target).length && $(".sub-sub-nav, .menu-link").removeClass("open active")
							}), !1
						}
						window.location.href = $(this).attr("href")
					}), $("#masthead nav > .mobile-wpml-select").length && $("#masthead nav > .mobile-wpml-select").insertAfter($("#mega-menu-wrap > ul > li").last()), $("#mega-menu-wrap").length) {
					function t(e, t, n) {
						null == e && (e = $(".sub-menu-wide").parent()), e.each(function () {
							if (e = $(this), null == t) var t = e.siblings();
							if ($(window).width() <= 768 || !e.length || !t.length) return !1;
							t.is(".main-menu-link.visible") && t.siblings("div.sub-nav").length > 0 ? e = t.siblings("div.sub-nav") : t.is("div.sub-nav") && (t = (e = t).siblings(".main-menu-link"));
							var n = e.find("ul.sub-menu-wide");
							n.each(function () {
								var e = $(this),
									t = 1;
								e.find("> .sub-nav-item").each(function () {
									t += $(this).outerWidth()
								}), e.innerWidth(t)
							});
							var i = 0;
							if ($("#masthead.header-2").length) {
								var o = $("#masthead.header-2 .header-wrap");
								i = $(window).width() - o.outerWidth() - o.offset().left
							}
							var s = $(window).width(),
								r = e.find("> ul").width(),
								a = 0;
							e.css({
								"max-width": s
							}), r > s && (e.addClass("sub-nav-onecol"), r = e.width());
							var l = t.outerWidth(),
								u = t.offset().left,
								c = s - t.offset().left - l;
							u < 0 && (a = -(u - r / 2 + l / 2) - i), c < r - l && (a = -(r - l - c) - i), n.outerWidth() >= s && (e.css("left", ""), n.innerWidth(s), a = -e.offset().left), e.css("left", a)
						})
					}
					$("#mega-menu-wrap").accessibleMegaMenu({
						...
						focusClass: "focus",
						openClass: "visible"
					}).on("megamenu:open", function (e, n) {
						$(this);
						var i, o = $(n);
						if ($(window).width() <= 768) return !1;
						if (o.is(".main-menu-link.visible") && o.siblings("div.sub-nav").length > 0) i = o.siblings("div.sub-nav");
						else {
							if (!o.is("div.sub-nav")) return !0;
							o = (i = o).siblings(".main-menu-link")
						}
						t(i)
					}), setTimeout(function () {
						t()
					}, 300), $("#mega-menu-wrap .sub-sub-nav").each(function () {
						if ($(this).offset().left + $(this).outerWidth() > $(window).width()) {
							$(this).addClass("menu-left");
							var e = $(this).find(".sub-sub-menu").outerWidth() + 5;
							$(this).css("left", -e)
						}
					})
				}
				$("a.cart .icon").on("click", function () {
					...
					$(".clb-hamburger-nav").removeClass("visible").find(".menu > li").each(function (e) {
						$(this).removeClass("showed active")
					})
				});
				var n = $(".clb-hamburger-nav-holder");
				n.length && (e = 0, $(document).on("mouseup touchstart", function (e) {
					0 === n.has(e.target).length && ($(".sub-nav > ul > li, .sub-nav .mega-menu-item > .sub-sub-nav > .sub-sub-menu > li").removeClass("showed active showed-onclick"), $(".nav-item").removeClass("active"), $(".sub-nav, .sub-sub-nav").removeClass("open-onclick"))
					...
					focusClass: "focus",
					openClass: "visible"
				}).on("megamenu:open", function (t, i) {
					$(this).find(".sub-nav:not(.visible) > ul > li, .sub-nav .mega-menu-item:not(:hover) > .sub-sub-nav > .sub-sub-menu > li").removeClass("showed active"), !$(window).width() >= 768 && $(this).find(".sub-nav.visible > ul > li, .sub-nav .mega-menu-item:hover > .sub-sub-nav > .sub-sub-menu > li").each(function (e) {
						var t = $(this);
						setTimeout(function () {
							t.parent().parent().parent().is(":hover") && t.addClass("showed")
						}, 40 * e)
					}), n.parents(".clb-hamburger-nav").hasClass("centered") && !$(window).width() >= 768 && $(".has-submenu > a .has-submenu-icon").on("click", function () {
						var t = $(this).parent().parent();
						return t.hasClass("menu-item-depth-0") && !t.hasClass("active") && (o(), t.addClass("active-main-item")), t.hasClass("menu-item-depth-" + e) || e++, t.hasClass("menu-item-depth-" + e) && !t.hasClass("active") && s(), r(t), t.addClass("active"), t.find("> .sub-nav, > .sub-sub-nav").addClass("open-onclick"), $(".open-onclick").find("> .sub-menu > .mega-menu-item, > .sub-sub-menu > .mega-menu-item ").addClass("showed-onclick"), !1
					}), $(window).width() <= 768 && $(".has-submenu > a").on("click touchend", function (t) {
						var n = $(this).parent();
						n.hasClass("menu-item-depth-0") && !n.hasClass("active") && o(), n.hasClass("menu-item-depth-" + e) || e++, n.hasClass("menu-item-depth-" + e) && !n.hasClass("active") && s(), n.addClass("active"), $(this).hasClass("showed") || ($(".sub-sub-nav .sub-sub-menu .sub-nav-item").removeClass("showed"), $(".sub-sub-nav .sub-sub-menu").removeClass("visible")), n.addClass("active"), n.find("> .sub-nav > .sub-menu > .sub-nav-item, > .sub-sub-nav > .sub-sub-menu > .sub-nav-item").addClass("showed"), n.find("> .sub-sub-nav > .sub-sub-menu").addClass("visible")
					})
				}), n.parents(".clb-hamburger-nav").hasClass("centered") && $(window).width() >= 768 && $(".clb-hamburger-nav-holder .sub-nav").on("mouseleave", function () {
					$(this).find("li").removeClass("showed")
				}));

				function i() {
					setTimeout(function () {
						var e = $(".menu-depth-1.active").height();
						$(".sub-menu.active").css("height", e + "px")
					}, 500)
				}

				function o() {
					e = 0, $(".sub-nav > ul.sub-menu, .sub-sub-nav > ul.sub-sub-menu, .submenu, .sub-nav-item").removeClass("active showed"), $(".nav-item").removeClass("active active-main-item"), $(".sub-nav, .sub-sub-nav").removeClass("open-onclick"), $(".sub-nav >.sub-menu, .sub-sub-nav >.sub-sub-menu").removeAttr("style")
				}

				function s(t) {
					var n = $(".menu-item-depth-" + e);
					n.removeClass("active"), n.find(".sub-nav > ul.sub-menu, .sub-sub-nav > ul.sub-sub-menu, .submenu, .sub-nav-item").removeClass("active showed-onclick"), n.find(".sub-nav, .sub-sub-nav").removeClass("open-onclick "), n.find(".sub-nav >.sub-menu, .sub-sub-nav >.sub-sub-menu").removeAttr("style")
				}

				function r(e) {
					e.hasClass("active-main-item") && o(), e.find(".sub-menu, .sub-sub-menu").removeAttr("style")
				}
			}(), $(".sub-menu-wide").each(function () {
				var e = $(this).find("> .mega-menu-item"),
					t = 0;
				$(window).width() > 1300 ? e.each(function () {
					t += $(this).width()
				}) : t = $(window).width(), $(this).css("width", t + 20 + "px");
				var n = $(this).offset().left,
					i = $(window).width() - t - n;
				$(this).parents(".sub-nav").css({
					left: i + "px"
				})
			}), $('[data-dynamic-text="true"]').each(function () {
				var e = $(this).find(".dynamic")[0],
					t = JSON.parse($(this).attr("data-dynamic-text-options"));
				new Typed(e, t)
			}), $(window).on("load", function () {
				var s, f, h, p, m, g;
				e(), $(".main-comment .main-comment-slider").each(function () {
						$(this).clbSlider({
							items: 1,
							gap: 40,
							loop: !0,
					...
					}), s = $("[data-isotope-grid]"), f = $(".demo-filter"), h = f.offset().top + f.outerHeight(), p = $(".demo-section").offset().top + $(".demo-section").height() - $(window).height(), s.isotope({
						percentPosition: !0
					}), f.find("a").on("click", function () {
						return f.find(".active").removeClass("active"), $(this).addClass("active"), s.isotope && s.isotope({
							filter: $(this).attr("data-filter")
						}), setTimeout(function () {
							"undefined" != typeof AOS && AOS.refresh(), h = f.offset().top + f.outerHeight(), p = $(".demo-section").offset().top + $(".demo-section").height() - $(window).height()
						}, 600), setTimeout(function () {
							d()
						}, 900), !1
					}), $(window).on("scroll", function (e) {
						var t = $(window).scrollTop();
						t > h && t < p ? (f.addClass("fixed"), setTimeout(function () {
							f.addClass("showed")
						}, 300)) : t < h ? (f.removeClass("showed"), f.removeClass("fixed")) : t > p && (f.css({
							transform: "translateY(100%)"
						}), setTimeout(function () {
							f.removeClass("showed"), f.removeClass("fixed"), f.removeAttr("style")
						}, 300))
					}), window.location.hash && f.find('a[href="' + window.location.hash + '"]').trigger("click"), r(), m = $("body").outerWidth(), $("body").offset().left, g = function (e, t, n, i) {
					...
					function () {
					...
					}(), a(), c(), d(), $(window).width() <= 768 ? ($("#masthead").addClass("mobile-header"), $("body").addClass("is-mobile-menu"), setTimeout(function () {
						...
						window.requestAnimationFrame ? window.requestAnimationFrame(function () {
							o()
						}) : o(), $(window).scrollTop() > 250 ? $("#clb-scroll-top").addClass("visible") : $("#clb-scroll-top").removeClass("visible")
				...
				$(".sub-menu-wide").removeAttr("style"), c()
			}), $(window).width() > 768 && setTimeout(function () {
				var e = 0,
					t = 0,
					n = setInterval(function () {
						$(".loader .loader-counter").html(t + "%"), $(".loader").css("width", t + "%"), t++, 101 == ++e && (clearInterval(n), $(".loader").fadeOut(300), $(".main-section, .site-header, .clb-social, .purchase-theme").addClass("visible"), $(".tablet, .laptop, .phone").addClass("active"), $(".with-promo").addClass("visible"))
					}, 15)
			})
	});